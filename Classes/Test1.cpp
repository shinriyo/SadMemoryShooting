...
bool Test1::init() {
    ...
    //create main loop
    this->schedule(schedule_selector(Test1::update));
...
void Test1::ccTouchesBegan(CCSet* pTouches, CCEvent* event) {
...
void Test1::fallingObjectDone (CCNode* pSender) {
...
void Test1::resetMeteor(void) {
    ...
    CCFiniteTimeAction*  sequence = CCSequence::create(
                                                       ...
                                                       CCCallFuncN::create(this, callfuncN_selector(Test1::fallingObjectDone)),
                                                       NULL);
...
void Test1::resetHealth(void) {
	...
	health->setPosition(ccp(health_x, 0));
    
    //create action (swing, move to target, and call function when done)
    CCFiniteTimeAction*  sequence = CCSequence::create(
                                                       CCMoveTo::create(_healthSpeed, ccp(health_target_x, _screenSize.height)),
                                                       CCCallFuncN::create(this, callfuncN_selector(Test1::fallingObjectDone)),
                                                       NULL);
...
void Test1::createActions() {
    ...
    _shockwaveSequence = CCSequence::create(
                                            ...
                                            CCCallFunc::create(this, callfunc_selector(Test1::shockwaveDone)),
                                            NULL);
    ...
    _groundHit = CCSequence::create(
                                    ...
                                    CCCallFuncN::create(this, callfuncN_selector(Test1::animationDone)),
                                    NULL
                                    );
    _groundHit->retain();
